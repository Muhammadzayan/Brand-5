$(document).ready(function() {
    ...
    $(".testi-slider").slick({
        ...
        autoplay:true,
        slidesToShow: 1,
        prevArrow:"<span class='arr-left slick-arrow'><i class='far fa-long-arrow-left'></i></span>",
        nextArrow:"<span class='arr-right slick-arrow'><i class='far fa-long-arrow-right'></i></span>"
            // prevArrow: $('.prev'),
            // nextArrow: $('.next')
    });
	...
	$('.popbtn').click(function(){
        ...
        var packprice = $(this).closest('.pckg').find(".pck-price").html();
...
$('#popupform').submit(function(e) {
        ...
        $.ajax({
            type: "POST",
            url: domain_url + 'cloud/include/signup.php',
            data: {
                name: name,
                email: email,
                phone: phone,
            ...
            success: function(data) {
                ...
                if(data=='error'){
        			...
        			$('.packageformsubmit').after('<div class="alreadyerror"> You are already a member. <a href="https://www.logoeminent.com/cloud">Click Here</a> to sign in.</div>');
        		} else {
    ...
    $('#popupform1').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data=='error'){
        			$('.packageformsubmit1').after('<div class="alreadyerror"> Something Went Wron Please Try Again.</div>');
        		} else if(data=='exists') {
        			$('.packageformsubmit1').after('<div class="alreadyerror"> You are already a member. <a href="https://www.logoeminent.com/cloud">Click Here</a> to sign in.</div>');
        		} else {
        		    window.location.replace(data);
        		}
                // if (data == 'success') {
